...
from .views import get_motor_status_view, home_motor_view, update_config_view, execute_route_view, move_motor_view, stop_motor_view, save_motor_config_view, get_motor_speeds_view, get_motor_max_speeds_view
...
urlpatterns = [
    ...
    path('maxSpeeds/', get_motor_max_speeds_view, name='get_motor_max_speed'),
